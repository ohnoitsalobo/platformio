#define wifissid "Lemongrass"
#define wifipassword "9182736450"
#define host_name "ledmongrass"
...
CRGBSet DOWN  (leds ( 0, 29) );    // when changing these layouts, remember
...
CRGB manualColor_LEFT = 0x330000, manualColor_RIGHT = 0x003300, manualColor_UP = 0x000033, manualColor_DOWN = 0x333333;
