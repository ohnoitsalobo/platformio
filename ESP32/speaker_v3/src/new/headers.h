...
CRGBSet R1  (RIGHT (0,            NUM_LEDS/4-1) );  // < subset 
CRGBSet R2  (RIGHT (NUM_LEDS/4,   NUM_LEDS/2-1) );  // < subset 
CRGBSet L1  (LEFT  (0,            NUM_LEDS/4-1) );  // < subset 
CRGBSet L2  (LEFT  (NUM_LEDS/4,   NUM_LEDS/2-1) );  // < subset 
