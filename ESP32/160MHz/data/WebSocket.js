var temp = [0], msgeq7;
// var connection = new WebSocket('ws://192.168.43.26:81/', ['arduino']);
...
var m = 0, r = 0, g = 0, b = 0, h = 0, s = 0, v = 0, g1 = 0, g2 = 0, ll = false, rr = false;
...
function process(){
    ...
    ll = document.getElementById('ll').checked;
    rr = document.getElementById('rr').checked;
    var mode = "";
...
function draw(){
    ...
    if(temp[0] == 'E' && m == 0){
        for(var i = 0; i < 42; i++){
            ...
            setHue(H);
            fill(color(rr, gg, bb));
            rect(0+i*25, height, 25, -int(temp[i+1])/1024*255);
